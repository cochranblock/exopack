...
> **Note:** ranges f120–f139 / t73–t80 (checkpoint, compaction, dual_mode, perm_gate) were kova-pattern test harnesses, removed from exopack v0.3 — they live in kova now. The tokens are reserved for kova consumers and not reused here.
